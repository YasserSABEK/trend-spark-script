...
interface InstagramHashtagCardProps {
  search: HashtagSearch;
  onDelete: () => void;
}

export const InstagramHashtagCard = ({ search, onDelete }: InstagramHashtagCardProps) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast({
        title: "Instagram hashtag search deleted",
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer group">
      ...
      <div className="aspect-[4/3] bg-gradient-to-br from-instagram-pink/20 via-instagram-purple/30 to-instagram-orange/20 flex items-center justify-center relative overflow-hidden">
      ...
      <CardContent className="p-4">
        ...
        {search.status === 'completed' && search.total_results > 0 ? (
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              navigate(`/instagram/hashtags/${search.hashtag}/reels`);
            }}
          >
